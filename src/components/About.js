...
import aboutimage from '../images/aboutimage.js'
import './About.css'
    ...
    return (
      <div className="About block color-block about-block" id="about">
        <div className="about-item">
          <img className="university-picture" src={ aboutimage } alt="University of Salerno"/>
        </div>
        <div className="about-item">
          <h1 className="about-text">About the conference</h1>
          <div className="about-text plain-text">
            ...
            <div className='organisers'>
              ...
              <ul className='organisers-list'>
                <li className='organisers-item'><a href="http://www.staff.uni-mainz.de/dfesti/">Dino Festi</a></li>
